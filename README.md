...
### 3、集成层
- 集成层的任务包括用于集成各种应用的智慧城市信息资源协调平台、智慧城市服务总线、物联网关和外部系统网关等组件。智能城市服务总线接收来自交通、水管和城市安全等物联网的信息；通过外部系统网关与公安、医院、社区、环保、电力等企事业单位实现互联互通。
### 4、外部资源层
- 外部资源层包括来自交通、水管和城市安全等物联网和公安、医院、社区、环保、电力等企事业单位的IT信息系统资源
### 5、云计算平台
- 云计算平台为了实现对资源的有效利用，并保证此架构可以满足未来技术发展的扩展要求
### 6、应用支撑共享平台
- 应用支撑共享平台由应用管理、平台管理、统一数据管理、共享引擎、决策分析、安全管理和运维管理等子系统组成。
### 7、基础数据平台
- 数据是智慧城市信息系统的根基，稳定、可靠的数据存储和访问，是所有应用系统的基础保证。智慧城市基础数据平台应该具有成熟性、高效性、可靠性、安全性、开放性、可扩展性、可移植性和易管理性的特性.
### 8、智慧城市实施
- 智慧城市实施路线一般分为三个阶段进行<br>
1）、整合资产和信息，构建智慧城市基础架构。包括创建智慧城市计算环境，构建数据中心，云计算中心；创建物联网基础平台，构建综合的信息感知体系；创建智慧城市基础架构，整合城市基础信息资源；构建智慧城市示范工程，如平安城市、电子政务、区域卫生等。<br>
2）、洞察和分析城市的方方面面，构建智慧的应用。其内容涵盖建设城市运营管理指挥中心，构建城市运营状态监控体系和城市统一协调运作管理体系。通过智能交通、智慧水资源、智慧电子商务、智慧物流等满足城市需求的智能应用<br>
3）、智慧优化，提高预测能力和区域服务能力。在建产数据基础和初步利用之后，实现城市运营关键绩效指标分析、仿真、优化与预测；城市运营决策支持；产业政策规划和制定的等功能